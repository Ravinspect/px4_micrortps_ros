...
offboard_control_mode::offboard_control_mode()
{
    ...
    m_timestamp_ = 0;
    // m_position_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@612679d6
    m_position_ = false;
    // m_velocity_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11758f2a
    m_velocity_ = false;
    // m_acceleration_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@e720b71
    m_acceleration_ = false;
    // m_attitude_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1b26f7b2
    m_attitude_ = false;
    // m_body_rate_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@491cc5c9
    m_body_rate_ = false;
