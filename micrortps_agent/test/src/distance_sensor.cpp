...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76a4d6c
    m_timestamp_ = 0;
    // m_device_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@517cd4b
    m_device_id_ = 0;
    // m_min_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6cc7b4de
    m_min_distance_ = 0.0;
    // m_max_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32cf48b7
    m_max_distance_ = 0.0;
    // m_current_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@d6da883
    m_current_distance_ = 0.0;
    // m_variance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49c43f4e
    m_variance_ = 0.0;
    // m_signal_quality_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@290dbf45
    m_signal_quality_ = 0;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12028586
    m_type_ = 0;
    // m_h_fov_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17776a8
    m_h_fov_ = 0.0;
    // m_v_fov_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69a10787
    m_v_fov_ = 0.0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@2d127a61
    memset(&m_q, 0, (4) * 4);
    // m_orientation_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2bbaf4f0
    m_orientation_ = 0;
