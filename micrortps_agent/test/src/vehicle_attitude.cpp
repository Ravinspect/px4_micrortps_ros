...
vehicle_attitude::vehicle_attitude()
{
    ...
    m_timestamp_ = 0;
    // m_timestamp_sample_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2473b9ce
    m_timestamp_sample_ = 0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@60438a68
    memset(&m_q, 0, (4) * 4);
    // m_delta_q_reset com.eprosima.idl.parser.typecode.AliasTypeCode@60438a68
    memset(&m_delta_q_reset, 0, (4) * 4);
    // m_quat_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@140e5a13
