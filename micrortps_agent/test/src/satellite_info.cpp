...
satellite_info::satellite_info()
{
    ...
    m_timestamp_ = 0;
    // m_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@588df31b
    m_count_ = 0;
    // m_svid com.eprosima.idl.parser.typecode.AliasTypeCode@33b37288
    memset(&m_svid, 0, (20) * 1);
    // m_used com.eprosima.idl.parser.typecode.AliasTypeCode@33b37288
    memset(&m_used, 0, (20) * 1);
    // m_elevation com.eprosima.idl.parser.typecode.AliasTypeCode@33b37288
    memset(&m_elevation, 0, (20) * 1);
    // m_azimuth com.eprosima.idl.parser.typecode.AliasTypeCode@33b37288
    memset(&m_azimuth, 0, (20) * 1);
    // m_snr com.eprosima.idl.parser.typecode.AliasTypeCode@33b37288
    memset(&m_snr, 0, (20) * 1);
    // m_prn com.eprosima.idl.parser.typecode.AliasTypeCode@33b37288
    memset(&m_prn, 0, (20) * 1);
