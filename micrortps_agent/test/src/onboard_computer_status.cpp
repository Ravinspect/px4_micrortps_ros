...
onboard_computer_status::onboard_computer_status()
{
    ...
    m_timestamp_ = 0;
    // m_uptime_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a40cd94
    m_uptime_ = 0;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f4168b8
    m_type_ = 0;
    // m_cpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@3bd94634
    memset(&m_cpu_cores, 0, (8) * 1);
    // m_cpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@58a90037
    memset(&m_cpu_combined, 0, (10) * 1);
    // m_gpu_cores com.eprosima.idl.parser.typecode.AliasTypeCode@130f889
    memset(&m_gpu_cores, 0, (4) * 1);
    // m_gpu_combined com.eprosima.idl.parser.typecode.AliasTypeCode@58a90037
    memset(&m_gpu_combined, 0, (10) * 1);
    // m_temperature_board_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1188e820
    m_temperature_board_ = 0;
    // m_temperature_core com.eprosima.idl.parser.typecode.AliasTypeCode@3bd94634
    memset(&m_temperature_core, 0, (8) * 1);
    // m_fan_speed com.eprosima.idl.parser.typecode.AliasTypeCode@2f490758
    memset(&m_fan_speed, 0, (4) * 2);
    // m_ram_usage_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@40f08448
    m_ram_usage_ = 0;
    // m_ram_total_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@276438c9
    m_ram_total_ = 0;
    // m_storage_type com.eprosima.idl.parser.typecode.AliasTypeCode@588df31b
    memset(&m_storage_type, 0, (4) * 4);
    // m_storage_usage com.eprosima.idl.parser.typecode.AliasTypeCode@588df31b
    memset(&m_storage_usage, 0, (4) * 4);
    // m_storage_total com.eprosima.idl.parser.typecode.AliasTypeCode@588df31b
    memset(&m_storage_total, 0, (4) * 4);
    // m_link_type com.eprosima.idl.parser.typecode.AliasTypeCode@6e2c9341
    memset(&m_link_type, 0, (6) * 4);
    // m_link_tx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@6e2c9341
    memset(&m_link_tx_rate, 0, (6) * 4);
    // m_link_rx_rate com.eprosima.idl.parser.typecode.AliasTypeCode@6e2c9341
    memset(&m_link_rx_rate, 0, (6) * 4);
    // m_link_tx_max com.eprosima.idl.parser.typecode.AliasTypeCode@6e2c9341
    memset(&m_link_tx_max, 0, (6) * 4);
    // m_link_rx_max com.eprosima.idl.parser.typecode.AliasTypeCode@6e2c9341
