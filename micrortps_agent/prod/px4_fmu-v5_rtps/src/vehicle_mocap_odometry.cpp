...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6cc7b4de
    m_timestamp_ = 0;
    // m_timestamp_sample_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32cf48b7
    m_timestamp_sample_ = 0;
    // m_local_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@679b62af
    m_local_frame_ = 0;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@45afc369
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@799d4f69
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49c43f4e
    m_z_ = 0.0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@290dbf45
    memset(&m_q, 0, (4) * 4);
    // m_q_offset com.eprosima.idl.parser.typecode.AliasTypeCode@290dbf45
    memset(&m_q_offset, 0, (4) * 4);
    // m_pose_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@12028586
    memset(&m_pose_covariance, 0, (21) * 4);
    // m_velocity_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17776a8
    m_velocity_frame_ = 0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69a10787
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2d127a61
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2bbaf4f0
    m_vz_ = 0.0;
    // m_rollspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11c20519
    m_rollspeed_ = 0.0;
    // m_pitchspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@70beb599
    m_pitchspeed_ = 0.0;
    // m_yawspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@33cb5951
    m_yawspeed_ = 0.0;
    // m_velocity_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@12028586
