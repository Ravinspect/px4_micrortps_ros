...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@50de0926
    m_timestamp_ = 0;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2473b9ce
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@60438a68
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@140e5a13
    m_z_ = 0.0;
    // m_yaw_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@71d15f18
    m_yaw_ = 0.0;
    // m_yawspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17695df3
    m_yawspeed_ = 0.0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6c9f5c0d
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2bea5ab4
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3d8314f0
    m_vz_ = 0.0;
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@2df32bf7
    memset(&m_acceleration, 0, (3) * 4);
    // m_jerk com.eprosima.idl.parser.typecode.AliasTypeCode@2df32bf7
    memset(&m_jerk, 0, (3) * 4);
    // m_thrust com.eprosima.idl.parser.typecode.AliasTypeCode@2df32bf7
