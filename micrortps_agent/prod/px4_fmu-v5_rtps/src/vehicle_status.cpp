...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3891771e
    m_timestamp_ = 0;
    // m_nav_state_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@78ac1102
    m_nav_state_ = 0;
    // m_nav_state_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2de8284b
    m_nav_state_timestamp_ = 0;
    // m_arming_state_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@396e2f39
    m_arming_state_ = 0;
    // m_hil_state_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@a74868d
    m_hil_state_ = 0;
    // m_failsafe_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12c8a2c0
    m_failsafe_ = false;
    // m_failsafe_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7e0e6aa2
    m_failsafe_timestamp_ = 0;
    // m_system_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@365185bd
    m_system_type_ = 0;
    // m_system_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@18bf3d14
    m_system_id_ = 0;
    // m_component_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4fb64261
    m_component_id_ = 0;
    // m_vehicle_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@42607a4f
    m_vehicle_type_ = 0;
    // m_is_vtol_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@782663d3
    m_is_vtol_ = false;
    // m_is_vtol_tailsitter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1990a65e
    m_is_vtol_tailsitter_ = false;
    // m_vtol_fw_permanent_stab_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@64485a47
    m_vtol_fw_permanent_stab_ = false;
    // m_in_transition_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@25bbf683
    m_in_transition_mode_ = false;
    // m_in_transition_to_fw_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@544a2ea6
    m_in_transition_to_fw_ = false;
    // m_rc_signal_lost_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@704d6e83
    m_rc_signal_lost_ = false;
    // m_rc_input_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@43a0cee9
    m_rc_input_mode_ = 0;
    // m_data_link_lost_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@eb21112
    m_data_link_lost_ = false;
    // m_data_link_lost_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2eda0940
    m_data_link_lost_counter_ = 0;
    // m_high_latency_data_link_lost_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3578436e
    m_high_latency_data_link_lost_ = false;
    // m_engine_failure_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@706a04ae
    m_engine_failure_ = false;
    // m_mission_failure_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6eceb130
    m_mission_failure_ = false;
    // m_geofence_violated_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10a035a0
    m_geofence_violated_ = false;
    // m_failure_detector_status_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@67b467e9
    m_failure_detector_status_ = 0;
    // m_onboard_control_sensors_present_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@47db50c5
    m_onboard_control_sensors_present_ = 0;
    // m_onboard_control_sensors_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c072e3f
    m_onboard_control_sensors_enabled_ = 0;
    // m_onboard_control_sensors_health_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d1b0d2a
    m_onboard_control_sensors_health_ = 0;
    // m_latest_arming_reason_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@954b04f
    m_latest_arming_reason_ = 0;
    // m_latest_disarming_reason_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@149494d8
    m_latest_disarming_reason_ = 0;
    // m_armed_time_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@710726a3
    m_armed_time_ = 0;
    // m_takeoff_time_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@646007f4
    m_takeoff_time_ = 0;
