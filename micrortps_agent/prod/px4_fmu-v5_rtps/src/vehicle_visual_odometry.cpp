...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5cdd8682
    m_timestamp_ = 0;
    // m_timestamp_sample_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@d6da883
    m_timestamp_sample_ = 0;
    // m_local_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@45afc369
    m_local_frame_ = 0;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@290dbf45
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12028586
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17776a8
    m_z_ = 0.0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@69a10787
    memset(&m_q, 0, (4) * 4);
    // m_q_offset com.eprosima.idl.parser.typecode.AliasTypeCode@69a10787
    memset(&m_q_offset, 0, (4) * 4);
    // m_pose_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@2d127a61
    memset(&m_pose_covariance, 0, (21) * 4);
    // m_velocity_frame_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2bbaf4f0
    m_velocity_frame_ = 0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11c20519
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@70beb599
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e41089d
    m_vz_ = 0.0;
    // m_rollspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32a068d1
    m_rollspeed_ = 0.0;
    // m_pitchspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@33cb5951
    m_pitchspeed_ = 0.0;
    // m_yawspeed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4148db48
    m_yawspeed_ = 0.0;
    // m_velocity_covariance com.eprosima.idl.parser.typecode.AliasTypeCode@2d127a61
