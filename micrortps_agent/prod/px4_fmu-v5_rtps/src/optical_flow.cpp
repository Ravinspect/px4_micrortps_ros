...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@22eeefeb
    m_timestamp_ = 0;
    // m_sensor_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17d0685f
    m_sensor_id_ = 0;
    // m_pixel_flow_x_integral_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3891771e
    m_pixel_flow_x_integral_ = 0.0;
    // m_pixel_flow_y_integral_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@78ac1102
    m_pixel_flow_y_integral_ = 0.0;
    // m_gyro_x_rate_integral_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2de8284b
    m_gyro_x_rate_integral_ = 0.0;
    // m_gyro_y_rate_integral_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@396e2f39
    m_gyro_y_rate_integral_ = 0.0;
    // m_gyro_z_rate_integral_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@a74868d
    m_gyro_z_rate_integral_ = 0.0;
    // m_ground_distance_m_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12c8a2c0
    m_ground_distance_m_ = 0.0;
    // m_integration_timespan_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7e0e6aa2
    m_integration_timespan_ = 0;
    // m_time_since_last_sonar_update_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@365185bd
    m_time_since_last_sonar_update_ = 0;
    // m_frame_count_since_last_readout_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@18bf3d14
    m_frame_count_since_last_readout_ = 0;
    // m_gyro_temperature_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4fb64261
    m_gyro_temperature_ = 0;
    // m_quality_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@42607a4f
    m_quality_ = 0;
    // m_max_flow_rate_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@782663d3
    m_max_flow_rate_ = 0.0;
    // m_min_ground_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1990a65e
    m_min_ground_distance_ = 0.0;
    // m_max_ground_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6ec8211c
    m_max_ground_distance_ = 0.0;
    // m_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10dba097
    m_mode_ = 0;
