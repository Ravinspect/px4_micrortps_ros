...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69a10787
    m_timestamp_ = 0;
    // m_connected_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2d127a61
    m_connected_ = false;
    // m_voltage_v_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2bbaf4f0
    m_voltage_v_ = 0.0;
    // m_voltage_filtered_v_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11c20519
    m_voltage_filtered_v_ = 0.0;
    // m_current_a_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@70beb599
    m_current_a_ = 0.0;
    // m_current_filtered_a_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e41089d
    m_current_filtered_a_ = 0.0;
    // m_current_average_a_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32a068d1
    m_current_average_a_ = 0.0;
    // m_discharged_mah_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@33cb5951
    m_discharged_mah_ = 0.0;
    // m_remaining_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@365c30cc
    m_remaining_ = 0.0;
    // m_scale_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@701fc37a
    m_scale_ = 0.0;
    // m_temperature_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4148db48
    m_temperature_ = 0.0;
    // m_cell_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@282003e1
    m_cell_count_ = 0;
    // m_source_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7fad8c79
    m_source_ = 0;
    // m_priority_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@71a794e5
    m_priority_ = 0;
    // m_capacity_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76329302
    m_capacity_ = 0;
    // m_cycle_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@b59d31
    m_cycle_count_ = 0;
    // m_run_time_to_empty_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23bb8443
    m_run_time_to_empty_ = 0;
    // m_average_time_to_empty_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1176dcec
    m_average_time_to_empty_ = 0;
    // m_serial_number_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@120d6fe6
    m_serial_number_ = 0;
    // m_manufacture_date_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4ba2ca36
    m_manufacture_date_ = 0;
    // m_state_of_health_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3444d69d
    m_state_of_health_ = 0;
    // m_max_error_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1372ed45
    m_max_error_ = 0;
    // m_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a79c292
    m_id_ = 0;
    // m_interface_error_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37574691
    m_interface_error_ = 0;
    // m_voltage_cell_v com.eprosima.idl.parser.typecode.AliasTypeCode@25359ed8
    memset(&m_voltage_cell_v, 0, (14) * 4);
    // m_max_cell_voltage_delta_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@21a947fe
    m_max_cell_voltage_delta_ = 0.0;
    // m_is_powering_off_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5606c0b
    m_is_powering_off_ = false;
    // m_warning_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@80ec1f8
    m_warning_ = 0;
    // m_average_power_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1445d7f
    m_average_power_ = 0.0;
    // m_available_energy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a396c1e
    m_available_energy_ = 0.0;
    // m_remaining_capacity_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6c3f5566
    m_remaining_capacity_ = 0.0;
    // m_design_capacity_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12405818
    m_design_capacity_ = 0.0;
    // m_average_time_to_full_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@314c508a
    m_average_time_to_full_ = 0;
    // m_over_discharge_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10b48321
    m_over_discharge_count_ = 0;
    // m_nominal_voltage_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6b67034
