...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1fc2b765
    m_timestamp_ = 0;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@75881071
    m_type_ = 0;
    // m_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a70a3d8
    m_mode_ = 0;
    // m_flow_control_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@289d1c02
    m_flow_control_ = false;
    // m_forwarding_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@22eeefeb
    m_forwarding_ = false;
    // m_mavlink_v2_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17d0685f
    m_mavlink_v2_ = false;
    // m_ftp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3891771e
    m_ftp_ = false;
    // m_streams_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@78ac1102
    m_streams_ = 0;
    // m_data_rate_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2de8284b
    m_data_rate_ = 0.0;
    // m_rate_multiplier_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@396e2f39
    m_rate_multiplier_ = 0.0;
    // m_tx_rate_avg_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@a74868d
    m_tx_rate_avg_ = 0.0;
    // m_tx_error_rate_avg_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12c8a2c0
    m_tx_error_rate_avg_ = 0.0;
    // m_tx_message_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7e0e6aa2
    m_tx_message_count_ = 0;
    // m_tx_buffer_overruns_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@365185bd
    m_tx_buffer_overruns_ = 0;
    // m_rx_rate_avg_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@18bf3d14
    m_rx_rate_avg_ = 0.0;
    // m_rx_message_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@782663d3
    m_rx_message_count_ = 0;
    // m_rx_message_lost_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2e3fc542
    m_rx_message_lost_count_ = 0;
    // m_rx_buffer_overruns_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@150c158
    m_rx_buffer_overruns_ = 0;
    // m_rx_parse_errors_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4524411f
    m_rx_parse_errors_ = 0;
    // m_rx_packet_drop_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@401e7803
    m_rx_packet_drop_count_ = 0;
    // m_rx_message_lost_rate_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10dba097
    m_rx_message_lost_rate_ = 0.0;
    // m_heartbeat_type_antenna_tracker_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1786f9d5
    m_heartbeat_type_antenna_tracker_ = false;
    // m_heartbeat_type_gcs_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@704d6e83
    m_heartbeat_type_gcs_ = false;
    // m_heartbeat_type_onboard_controller_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@43a0cee9
    m_heartbeat_type_onboard_controller_ = false;
    // m_heartbeat_type_gimbal_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@eb21112
    m_heartbeat_type_gimbal_ = false;
    // m_heartbeat_type_adsb_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2eda0940
    m_heartbeat_type_adsb_ = false;
    // m_heartbeat_type_camera_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3578436e
    m_heartbeat_type_camera_ = false;
    // m_heartbeat_component_telemetry_radio_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@706a04ae
    m_heartbeat_component_telemetry_radio_ = false;
    // m_heartbeat_component_log_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6eceb130
    m_heartbeat_component_log_ = false;
    // m_heartbeat_component_osd_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@10a035a0
    m_heartbeat_component_osd_ = false;
    // m_heartbeat_component_obstacle_avoidance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@67b467e9
    m_heartbeat_component_obstacle_avoidance_ = false;
    // m_heartbeat_component_vio_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@47db50c5
    m_heartbeat_component_vio_ = false;
    // m_heartbeat_component_pairing_manager_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c072e3f
    m_heartbeat_component_pairing_manager_ = false;
    // m_heartbeat_component_udp_bridge_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d1b0d2a
    m_heartbeat_component_udp_bridge_ = false;
    // m_heartbeat_component_uart_bridge_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@954b04f
    m_heartbeat_component_uart_bridge_ = false;
    // m_avoidance_system_healthy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@149494d8
