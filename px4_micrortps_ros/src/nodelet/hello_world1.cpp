...
namespace px4_micrortps_ros
{
    ...
    **********/
    ...
    // nodelet::Nodelet
    class Hello_World1 : public nodelet::Nodelet
    {
        ...
        private:
            ...
            virtual void onInit()
            {
                ...
                NODELET_DEBUG("Initializing nodelet nodelet1...");
             
                // Create a publisher topic
                pub = private_nh.advertise<std_msgs::String>("ros_out1",10); 
             
                // Create a subscriber topic
                sub = private_nh.subscribe("ros_in1",10, &Hello_World1::callback, this);  
            }
    ...
    // Export the Hello_World1 class as a plugin using the
    // PLUGINLIB_EXPORT_CLASS macro.
    PLUGINLIB_EXPORT_CLASS(px4_micrortps_ros::Hello_World1, nodelet::Nodelet);
}
