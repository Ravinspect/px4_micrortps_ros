...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@290dbf45
    m_timestamp_ = 0;
    // m_connected_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12028586
    m_connected_ = false;
    // m_voltage_v_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17776a8
    m_voltage_v_ = 0.0;
    // m_voltage_filtered_v_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69a10787
    m_voltage_filtered_v_ = 0.0;
    // m_current_a_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2d127a61
    m_current_a_ = 0.0;
    // m_current_filtered_a_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2bbaf4f0
    m_current_filtered_a_ = 0.0;
    // m_current_average_a_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11c20519
    m_current_average_a_ = 0.0;
    // m_discharged_mah_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@70beb599
    m_discharged_mah_ = 0.0;
    // m_remaining_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e41089d
    m_remaining_ = 0.0;
    // m_scale_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32a068d1
    m_scale_ = 0.0;
    // m_temperature_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@33cb5951
    m_temperature_ = 0.0;
    // m_cell_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@365c30cc
    m_cell_count_ = 0;
    // m_source_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@701fc37a
    m_source_ = 0;
    // m_priority_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4148db48
    m_priority_ = 0;
    // m_capacity_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@282003e1
    m_capacity_ = 0;
    // m_cycle_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76329302
    m_cycle_count_ = 0;
    // m_run_time_to_empty_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@31206beb
    m_run_time_to_empty_ = 0;
    // m_average_time_to_empty_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e77a1ed
    m_average_time_to_empty_ = 0;
    // m_serial_number_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3ffcd140
    m_serial_number_ = 0;
    // m_manufacture_date_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23bb8443
    m_manufacture_date_ = 0;
    // m_state_of_health_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1176dcec
    m_state_of_health_ = 0;
    // m_max_error_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@120d6fe6
    m_max_error_ = 0;
    // m_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4ba2ca36
    m_id_ = 0;
    // m_interface_error_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3444d69d
    m_interface_error_ = 0;
    // m_voltage_cell_v com.eprosima.idl.parser.typecode.AliasTypeCode@1372ed45
    memset(&m_voltage_cell_v, 0, (14) * 4);
    // m_max_cell_voltage_delta_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a79c292
    m_max_cell_voltage_delta_ = 0.0;
    // m_is_powering_off_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37574691
    m_is_powering_off_ = false;
    // m_warning_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@25359ed8
    m_warning_ = 0;
    // m_average_power_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@21a947fe
    m_average_power_ = 0.0;
    // m_available_energy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5606c0b
    m_available_energy_ = 0.0;
    // m_remaining_capacity_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@80ec1f8
    m_remaining_capacity_ = 0.0;
    // m_design_capacity_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1445d7f
    m_design_capacity_ = 0.0;
    // m_average_time_to_full_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a396c1e
    m_average_time_to_full_ = 0;
    // m_over_discharge_count_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6c3f5566
    m_over_discharge_count_ = 0;
    // m_nominal_voltage_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12405818
    m_nominal_voltage_ = 0.0;
...
battery_status::battery_status(const battery_status &x)
{
    ...
    m_current_average_a_ = x.m_current_average_a_;
    ...
    m_average_power_ = x.m_average_power_;
    m_available_energy_ = x.m_available_energy_;
    m_remaining_capacity_ = x.m_remaining_capacity_;
    m_design_capacity_ = x.m_design_capacity_;
    m_average_time_to_full_ = x.m_average_time_to_full_;
    m_over_discharge_count_ = x.m_over_discharge_count_;
    m_nominal_voltage_ = x.m_nominal_voltage_;
}
...
void battery_status::serialize(eprosima::fastcdr::Cdr &scdr) const
{
    ...
    scdr << m_warning_;
    scdr << m_average_power_;
    scdr << m_available_energy_;
    scdr << m_remaining_capacity_;
    scdr << m_design_capacity_;
    scdr << m_average_time_to_full_;
    scdr << m_over_discharge_count_;
    scdr << m_nominal_voltage_;
}
...
void battery_status::deserialize(eprosima::fastcdr::Cdr &dcdr)
{
    ...
    dcdr >> m_warning_;
    dcdr >> m_average_power_;
    dcdr >> m_available_energy_;
    dcdr >> m_remaining_capacity_;
    dcdr >> m_design_capacity_;
    dcdr >> m_average_time_to_full_;
    dcdr >> m_over_discharge_count_;
    dcdr >> m_nominal_voltage_;
}
 ...
 */
void battery_status::current_average_a_(float _current_average_a_)
{
m_current_average_a_ = _current_average_a_;
}
 ...
 */
float battery_status::current_average_a_() const
{
    return m_current_average_a_;
}
 ...
 */
float& battery_status::current_average_a_()
{
    return m_current_average_a_;
}
 ...
 */
void battery_status::voltage_cell_v(const battery_status__float_array_14 &_voltage_cell_v)
{
 ...
 */
void battery_status::voltage_cell_v(battery_status__float_array_14 &&_voltage_cell_v)
{
 ...
 */
const battery_status__float_array_14& battery_status::voltage_cell_v() const
{
 ...
 */
battery_status__float_array_14& battery_status::voltage_cell_v()
{
    return m_voltage_cell_v;
}
/*!
 ...
 */
void battery_status::average_power_(float _average_power_)
{
m_average_power_ = _average_power_;
}
 ...
 */
float battery_status::average_power_() const
{
    return m_average_power_;
}
 ...
 */
float& battery_status::average_power_()
{
    return m_average_power_;
}
 ...
 */
void battery_status::available_energy_(float _available_energy_)
{
m_available_energy_ = _available_energy_;
}
 ...
 */
float battery_status::available_energy_() const
{
    return m_available_energy_;
}
 ...
 */
float& battery_status::available_energy_()
{
    return m_available_energy_;
}
 ...
 */
void battery_status::remaining_capacity_(float _remaining_capacity_)
{
m_remaining_capacity_ = _remaining_capacity_;
}
 ...
 */
float battery_status::remaining_capacity_() const
{
    return m_remaining_capacity_;
}
 ...
 */
float& battery_status::remaining_capacity_()
{
    return m_remaining_capacity_;
}
 ...
 */
void battery_status::design_capacity_(float _design_capacity_)
{
m_design_capacity_ = _design_capacity_;
}
 ...
 */
float battery_status::design_capacity_() const
{
    return m_design_capacity_;
}
 ...
 */
float& battery_status::design_capacity_()
{
    return m_design_capacity_;
}
 ...
 */
void battery_status::average_time_to_full_(uint16_t _average_time_to_full_)
{
m_average_time_to_full_ = _average_time_to_full_;
}
 ...
 */
uint16_t battery_status::average_time_to_full_() const
{
    return m_average_time_to_full_;
}
 ...
 */
uint16_t& battery_status::average_time_to_full_()
{
    return m_average_time_to_full_;
}
 ...
 */
void battery_status::over_discharge_count_(uint16_t _over_discharge_count_)
{
m_over_discharge_count_ = _over_discharge_count_;
}
 ...
 */
uint16_t battery_status::over_discharge_count_() const
{
    return m_over_discharge_count_;
}
 ...
 */
uint16_t& battery_status::over_discharge_count_()
{
    return m_over_discharge_count_;
}
 ...
 */
void battery_status::nominal_voltage_(float _nominal_voltage_)
{
m_nominal_voltage_ = _nominal_voltage_;
}
 ...
 */
float battery_status::nominal_voltage_() const
{
    return m_nominal_voltage_;
}
 ...
 */
float& battery_status::nominal_voltage_()
{
    return m_nominal_voltage_;
}
