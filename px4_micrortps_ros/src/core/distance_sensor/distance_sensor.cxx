...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1442d7b5
    m_timestamp_ = 0;
    // m_device_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1efee8e7
    m_device_id_ = 0;
    // m_min_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ee807c6
    m_min_distance_ = 0.0;
    // m_max_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76a4d6c
    m_max_distance_ = 0.0;
    // m_current_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32cf48b7
    m_current_distance_ = 0.0;
    // m_variance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@d6da883
    m_variance_ = 0.0;
    // m_signal_quality_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@45afc369
    m_signal_quality_ = 0;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@799d4f69
    m_type_ = 0;
    // m_h_fov_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49c43f4e
    m_h_fov_ = 0.0;
    // m_v_fov_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@290dbf45
    m_v_fov_ = 0.0;
    // m_q com.eprosima.idl.parser.typecode.AliasTypeCode@12028586
    memset(&m_q, 0, (4) * 4);
    // m_orientation_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17776a8
    m_orientation_ = 0;
 ...
 */
void distance_sensor::device_id_(uint32_t _device_id_)
{
 ...
 */
uint32_t distance_sensor::device_id_() const
{
    return m_device_id_;
}
 ...
 */
uint32_t& distance_sensor::device_id_()
{
    return m_device_id_;
}
