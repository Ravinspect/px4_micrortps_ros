...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@33b37288
    m_timestamp_ = 0;
    // m_timestamp_sample_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77a57272
    m_timestamp_sample_ = 0;
    // m_xy_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7181ae3f
    m_xy_valid_ = false;
    // m_z_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@46238e3f
    m_z_valid_ = false;
    // m_v_xy_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6e2c9341
    m_v_xy_valid_ = false;
    // m_v_z_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32464a14
    m_v_z_valid_ = false;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e4aea35
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1442d7b5
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1efee8e7
    m_z_ = 0.0;
    // m_delta_xy com.eprosima.idl.parser.typecode.AliasTypeCode@1ee807c6
    memset(&m_delta_xy, 0, (2) * 4);
    // m_xy_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76a4d6c
    m_xy_reset_counter_ = 0;
    // m_delta_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@517cd4b
    m_delta_z_ = 0.0;
    // m_z_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6cc7b4de
    m_z_reset_counter_ = 0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32cf48b7
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@679b62af
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@45afc369
    m_vz_ = 0.0;
    // m_z_deriv_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@290dbf45
    m_z_deriv_ = 0.0;
    // m_delta_vxy com.eprosima.idl.parser.typecode.AliasTypeCode@1ee807c6
    memset(&m_delta_vxy, 0, (2) * 4);
    // m_vxy_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2bbaf4f0
    m_vxy_reset_counter_ = 0;
    // m_delta_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11c20519
    m_delta_vz_ = 0.0;
    // m_vz_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@70beb599
    m_vz_reset_counter_ = 0;
    // m_ax_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e41089d
    m_ax_ = 0.0;
    // m_ay_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32a068d1
    m_ay_ = 0.0;
    // m_az_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@33cb5951
    m_az_ = 0.0;
    // m_heading_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@365c30cc
    m_heading_ = 0.0;
    // m_delta_heading_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@701fc37a
    m_delta_heading_ = 0.0;
    // m_heading_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4148db48
    m_heading_reset_counter_ = 0;
    // m_xy_global_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@282003e1
    m_xy_global_ = false;
    // m_z_global_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7fad8c79
    m_z_global_ = false;
    // m_ref_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@71a794e5
    m_ref_timestamp_ = 0;
    // m_ref_lat_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76329302
    m_ref_lat_ = 0.0;
    // m_ref_lon_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5e25a92e
    m_ref_lon_ = 0.0;
    // m_ref_alt_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4df828d7
    m_ref_alt_ = 0.0;
    // m_dist_bottom_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@b59d31
    m_dist_bottom_ = 0.0;
    // m_dist_bottom_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@62fdb4a6
    m_dist_bottom_valid_ = false;
    // m_dist_bottom_sensor_bitfield_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11e21d0e
    m_dist_bottom_sensor_bitfield_ = 0;
    // m_eph_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1dd02175
    m_eph_ = 0.0;
    // m_epv_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@31206beb
    m_epv_ = 0.0;
    // m_evh_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e77a1ed
    m_evh_ = 0.0;
    // m_evv_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3ffcd140
    m_evv_ = 0.0;
    // m_vxy_max_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23bb8443
    m_vxy_max_ = 0.0;
    // m_vz_max_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1176dcec
    m_vz_max_ = 0.0;
    // m_hagl_min_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@120d6fe6
    m_hagl_min_ = 0.0;
    // m_hagl_max_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4ba2ca36
    m_hagl_max_ = 0.0;
