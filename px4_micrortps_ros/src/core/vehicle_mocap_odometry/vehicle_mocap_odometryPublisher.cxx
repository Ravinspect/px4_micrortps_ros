...
/*!
 * @file vehicle_mocap_odometryPublisher.cpp
...
vehicle_mocap_odometryPublisher::vehicle_mocap_odometryPublisher() : mp_participant(nullptr), mp_publisher(nullptr) {}

vehicle_mocap_odometryPublisher::~vehicle_mocap_odometryPublisher() {	Domain::removeParticipant(mp_participant);}

bool vehicle_mocap_odometryPublisher::init()
{
    ...
    Wparam.topic.topicName = "vehicle_mocap_odometryPubSubTopic";
...
void vehicle_mocap_odometryPublisher::PubListener::onPublicationMatched(Publisher* pub,MatchingInfo& info)
{
    (void)pub;
...
void vehicle_mocap_odometryPublisher::run(const px4_msgs::VehicleMocapOdometry& input)
{
