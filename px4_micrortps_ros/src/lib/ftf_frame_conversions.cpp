 ...
 *
 * This file is part of the px4_micrortps_ros_lib package and subject to the license terms
 * in the top-level LICENSE file of the px4_micrortps_ros_lib repository.
 * https://github.com/mavlink/px4_micrortps_ros_lib/tree/master/LICENSE.md
 */

#include <lib/frame_tf.h>

namespace px4_micrortps_ros_lib {
namespace ftf {
namespace detail {
/**
